...
- `20260715-backend-upstream-v7-2-77-absorption`：后端 `v7.2.80` 已提交并推送 `dev@81f11fa4`，当前等待代码合入 `master` 的单独授权。
...
- `20260708-upstream-v7-2-52-absorption`：后端独立吸收 `upstream/main@14b13966` / `v7.2.52`；当前处于候选合并前确认阶段。
