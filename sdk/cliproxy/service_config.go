...
func (s *Service) applyConfigRuntime(ctx context.Context, commit configCommit, synthesizeConfigAuths bool) bool {
	...
	applyUsageStatisticsEnabled(cfg.UsageStatisticsEnabled)
	s.applyUsagePersistenceConfigChange(commit.previousUsageEnabled, commit.previousUsagePersistenceInterval, cfg)
