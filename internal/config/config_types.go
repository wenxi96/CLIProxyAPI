...
type QuotaExceeded struct {
	...
	// AutoDisableAuthFileOnLowQuota disables file-backed auths after a confirmed low-quota result.
	AutoDisableAuthFileOnLowQuota bool `yaml:"auto-disable-auth-file-on-low-quota" json:"auto-disable-auth-file-on-low-quota"`

	// AutoDisableAuthFileQuotaThresholdPercent is the remaining-quota threshold for auto-disable.
	...
	// ActiveQuotaRefresh configures background quota checks for recently used auth files.
...
type RoutingConfig struct {
	...
	// ClaudeCodeSessionAffinity is the legacy Claude Code-only session affinity switch.
	// Deprecated: use SessionAffinity for universal session support.
...
type RoutingScopedPoolConfig struct {
	...
	// When nil, legacy configs infer enablement from provider overrides.
	Enabled *bool `yaml:"enabled,omitempty" json:"enabled,omitempty"`
