...
type Config struct {
	...
	// UsageStatisticsPersistIntervalSeconds controls periodic usage-statistics persistence.
	// A non-positive value disables the periodic flush while retaining startup/shutdown persistence.
