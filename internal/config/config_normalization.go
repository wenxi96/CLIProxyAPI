...
func (cfg *Config) SanitizeClaudeKeys() {
	...
	for i := range cfg.ClaudeKey {
		...
		// Only recognized values are rewritten so sanitizing a config file never
		// destroys operator input. The request path falls back to the default
		// profile and reports an unrecognized value once.
